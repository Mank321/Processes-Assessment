...
class MainMenu(Entity):
    def __init__(self, start_func, resume_func, bg=ORIGIN_BACKGROUND, header='The Dungeon', text='Start', y=0, enabled=True):
        ...
        Text(header, parent=self.main_menu, y=0.25, x=0, z=-10, scale=5, origin=(0,0))
